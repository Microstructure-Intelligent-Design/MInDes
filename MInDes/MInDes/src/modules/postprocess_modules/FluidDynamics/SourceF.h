...
namespace pf {
	...
	enum LBM_Force_Term_Model { LBM_FTM_NONE, LBM_FTM_LGA, LBM_FTM_ZS_Guo };
	enum LBM_Force_Type { LBM_FM_ThermalExpansion, LBM_FM_ConExpansion, LBM_FM_Gravity };
	namespace lbm_source {
		...
		// - 
		inline std::vector<LBM_Force_Type> lbm_force;
		namespace force_funcs {
			...
			// 
			inline std::vector<double> ref_cons;
			inline std::vector<double> con_expansion_parameters;
