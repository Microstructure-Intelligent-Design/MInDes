	...
	namespace dendrite_solidification_model {
		...
		*/
		inline void init_model_modules() {
			...
			load_a_new_module(nullptr, nullptr, dendrite_solidification_model::exec_pre_iii,  // exec_pre_i   exec_pre_ii    exec_pre_iii
				dendrite_solidification_model::exec_i, nullptr, nullptr,  // exec_i   exec_ii    exec_iii
				nullptr, nullptr, nullptr,   // exec_pos_i   exec_pos_ii    exec_pos_iii
				dendrite_solidification_model::deinit);  // deinit
		}
	}
}
